...
{
	if (region.a6.ax === region.bl.ax)
	{
		return 'on line ' + region.a6.ax;
	}
	return 'on lines ' + region.a6.ax + ' through ' + region.bl.ax;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cZ: 'hidden', cC: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cZ: 'mozHidden', cC: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cZ: 'msHidden', cC: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cZ: 'webkitHidden', cC: 'webkitvisibilitychange' }
		: { cZ: 'hidden', cC: 'visibilitychange' };
}
...
var $author$project$Main$Monochromatic = 7;
...
var $author$project$Main$defaultColor = A3($avh4$elm_color$Color$rgb255, 192, 46, 255);
var $author$project$Main$DragAndDrop = function (a) {
	return {$: 6, a: a};
};
var $annaghi$dnd_list$DnDList$Free = 0;
		...
		if (model.$ === 1) {
			...
			if (_v2.$ === 1) {
				return A2(
					...
					$elm$browser$Browser$Dom$getElement(state.ah));
			} else {
				return $elm$core$Platform$Cmd$none;
			}
		}
	...
	function (stepMsg, _v0) {
		...
		if (model.$ === 1) {
			...
			return (!state.m) ? A2(
				...
				$elm$browser$Browser$Dom$getElement(state.S)) : $elm$core$Platform$Cmd$none;
		}
	});
						...
						return _List_fromArray(
							[
								...
								A2(
									...
									$elm$core$Basics$round((state.P.ac - state.ap.ac) + element.ac),
									$elm$core$Basics$round(element.ad))),
								A2(
								$elm$html$Html$Attributes$style,
								'height',
								$annaghi$dnd_list$Utils$px(
									$elm$core$Basics$round(element.br))),
								A2(
								$elm$html$Html$Attributes$style,
								'width',
								$annaghi$dnd_list$Utils$px(
									$elm$core$Basics$round(element.a8))),
						...
						return _List_fromArray(
							[
								...
								A2(
									...
									$elm$core$Basics$round((state.P.ad - state.ap.ad) + element.ad))),
								A2(
								$elm$html$Html$Attributes$style,
								'height',
								$annaghi$dnd_list$Utils$px(
			...
			return A3(
				...
				F2(
					function (dragElement, dropElement) {
						return {F: dragElement, ah: state.ah, bk: state.bk, R: dropElement, S: state.S, r: state.r};
					}),
				state.F,
				state.R);
		},
...
var $annaghi$dnd_list$Operations$afterBackward = F3(
	function (i, j, list) {
		var _v0 = A2($annaghi$dnd_list$Operations$splitAt, j + 1, list);
		var beginning = _v0.a;
		var rest = _v0.b;
		var _v1 = A2($annaghi$dnd_list$Operations$splitAt, (i - j) - 1, rest);
		var middle = _v1.a;
		var end = _v1.b;
		var _v2 = A2($annaghi$dnd_list$Operations$splitAt, 1, end);
		var head = _v2.a;
		var tail = _v2.b;
		return _Utils_ap(
			beginning,
...
var $annaghi$dnd_list$Operations$afterForward = F3(
	function (i, j, list) {
		var _v0 = A2($annaghi$dnd_list$Operations$splitAt, i, list);
		var beginning = _v0.a;
		var rest = _v0.b;
		var _v1 = A2($annaghi$dnd_list$Operations$splitAt, (j - i) + 1, rest);
		var middle = _v1.a;
		var end = _v1.b;
		var _v2 = A2($annaghi$dnd_list$Operations$splitAt, 1, middle);
		var head = _v2.a;
		var tail = _v2.b;
		return _Utils_ap(
			beginning,
...
var $annaghi$dnd_list$Operations$beforeBackward = F3(
	function (i, j, list) {
		var _v0 = A2($annaghi$dnd_list$Operations$splitAt, j, list);
		var beginning = _v0.a;
		var rest = _v0.b;
		var _v1 = A2($annaghi$dnd_list$Operations$splitAt, i - j, rest);
		var middle = _v1.a;
		var end = _v1.b;
		var _v2 = A2($annaghi$dnd_list$Operations$splitAt, 1, end);
		var head = _v2.a;
...
var $annaghi$dnd_list$Operations$beforeForward = F3(
	function (i, j, list) {
		...
		var beginning = _v0.a;
		var rest = _v0.b;
		var _v1 = A2($annaghi$dnd_list$Operations$splitAt, j - i, rest);
		var middle = _v1.a;
		var end = _v1.b;
		var _v2 = A2($annaghi$dnd_list$Operations$splitAt, 1, middle);
		var head = _v2.a;
		...
		switch (operation) {
			case 0:
				return _Utils_update(
					...
					{
						m: 0,
						bk: (_Utils_cmp(dropIndex, state.bk) < 0) ? (dropIndex + 1) : dropIndex
					});
			case 1:
				return _Utils_update(
					state,
					{
						m: 0,
						bk: (_Utils_cmp(state.bk, dropIndex) < 0) ? (dropIndex - 1) : dropIndex
					});
			case 2:
				return _Utils_update(
					state,
...
var $annaghi$dnd_list$DnDList$update = F4(
	function (_v0, msg, _v1, list) {
		var beforeUpdate = _v0.cm;
		var listen = _v0.dd;
		var operation = _v0.dr;
		var model = _v1;
		switch (msg.$) {
			case 0:
				var dragIndex = msg.a;
				...
				return _Utils_Tuple2(
					$elm$core$Maybe$Just(
						{P: xy, m: 0, F: $elm$core$Maybe$Nothing, ah: dragElementId, bk: dragIndex, R: $elm$core$Maybe$Nothing, S: dragElementId, r: dragIndex, ap: xy}),
					list);
			case 1:
				var xy = msg.a;
				return _Utils_Tuple2(
			...
			case 3:
				...
				if ((!_v3.a.$) && (!_v3.b)) {
					var state = _v3.a.a;
					var _v4 = _v3.b;
					return ((state.m > 1) && (!_Utils_eq(state.bk, dropIndex))) ? _Utils_Tuple2(
						$elm$core$Maybe$Just(
						...
						A4(
							...
							state.bk,
							dropIndex,
							A3(beforeUpdate, state.bk, dropIndex, list))) : _Utils_Tuple2(model, list);
				} else {
					return _Utils_Tuple2(
						A2(
							$elm$core$Maybe$map,
			...
			case 5:
				...
				if ((!_v5.a.$) && (_v5.b === 1)) {
					var state = _v5.a.a;
					var _v6 = _v5.b;
					return (!_Utils_eq(state.bk, state.r)) ? _Utils_Tuple2(
						$elm$core$Maybe$Nothing,
						A4(
							$annaghi$dnd_list$DnDList$listUpdate,
							operation,
							state.bk,
							state.r,
							A3(beforeUpdate, state.bk, state.r, list))) : _Utils_Tuple2($elm$core$Maybe$Nothing, list);
				} else {
						...
						A2(
							...
							function (state) {
								return _Utils_update(
									state,
									{
										R: $elm$core$Maybe$Just(dropElement)
									});
							},
							model),
						list);
...
var $annaghi$dnd_list$DnDList$create = F2(
	function (config, stepMsg) {
		return {
			cH: $annaghi$dnd_list$DnDList$commands(stepMsg),
			cN: $annaghi$dnd_list$DnDList$dragEvents(stepMsg),
			cO: $annaghi$dnd_list$DnDList$dropEvents(stepMsg),
			cU: $annaghi$dnd_list$DnDList$ghostStyles(config.di),
			bw: $annaghi$dnd_list$DnDList$info,
			dh: $elm$core$Maybe$Nothing,
			bX: $annaghi$dnd_list$DnDList$subscriptions(stepMsg),
			b$: $annaghi$dnd_list$DnDList$update(config)
		};
	});
var $author$project$Main$dndSystem = function () {
	var dndConfig = {
		cm: F3(
	...
	return A2($annaghi$dnd_list$DnDList$create, dndConfig, $author$project$Main$DragAndDrop);
}();
var $simonh1000$elm_colorpicker$ColorPicker$State = $elm$core$Basics$identity;
var $simonh1000$elm_colorpicker$ColorPicker$Unpressed = {$: 0};
var $simonh1000$elm_colorpicker$ColorPicker$blankModel = {av: $elm$core$Maybe$Nothing, I: $simonh1000$elm_colorpicker$ColorPicker$Unpressed};
var $simonh1000$elm_colorpicker$ColorPicker$empty = $simonh1000$elm_colorpicker$ColorPicker$blankModel;
...
var $avh4$elm_color$Color$toHsla = function (_v0) {
	...
	return {aF: a, av: h3, o: l, ay: s};
};
var $author$project$Main$pickMonochromatic = function (baseColor) {
	var makeOverflow = F2(
		function (num, max) {
			return (_Utils_cmp(num, max) < 1) ? num : (num - max);
		});
	return A2(
		$elm$core$List$map,
		...
		A2(
			...
			function (hsla) {
				return A2(
					...
					function (index) {
						return _Utils_update(
							hsla,
							{
								o: A2(makeOverflow, hsla.o + (index * 0.2), 1)
							});
					},
					A2(
						$elm$core$List$map,
				...
				$avh4$elm_color$Color$toHsla(baseColor))));
};
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			at: $simonh1000$elm_colorpicker$ColorPicker$empty,
			E: $author$project$Main$dndSystem.dh,
			a_: $elm$core$Maybe$Nothing,
			G: $elm$core$Maybe$Nothing,
			t: $author$project$Main$defaultColor,
			aP: 7,
			b: $author$project$Main$pickMonochromatic($author$project$Main$defaultColor)
		},
		$elm$core$Platform$Cmd$none);
};
var $author$project$Main$subscriptions = function (model) {
	return $author$project$Main$dndSystem.bX(model.E);
};
var $author$project$Main$Lightness = 2;
var $author$project$Main$Saturation = 1;
...
var $author$project$Main$adjustColor = F4(
	function (model, adjustingElement, index, value) {
		var arrayedColors = $elm$core$Array$fromList(model.b);
		var colorToBeAdjusted = A2($elm$core$Array$get, index, arrayedColors);
		if (!colorToBeAdjusted.$) {
			var color = colorToBeAdjusted.a;
			return $elm$core$Result$Ok(
				$avh4$elm_color$Color$fromHsla(
					function (hsla) {
						switch (adjustingElement) {
							case 0:
								return _Utils_update(
									hsla,
									{av: value});
						...
						$avh4$elm_color$Color$toHsla(color))));
		} else {
			return $elm$core$Result$Err('Failed to get an element from an array.');
		}
	});
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$Main$copyString = _Platform_outgoingPort('copyString', $elm$json$Json$Encode$string);
...
var $simonh1000$elm_colorpicker$ColorPicker$calcOpacity = F3(
	function (col, _v0, _v1) {
		var x = _v1.ac;
		var mousePressed = _v1.aj;
		var hsla = $avh4$elm_color$Color$toHsla(col);
		return $avh4$elm_color$Color$fromHsla(
			_Utils_update(
				hsla,
				{aF: x / $simonh1000$elm_colorpicker$ColorPicker$widgetWidth}));
	});
...
var $simonh1000$elm_colorpicker$ColorPicker$calcSatLight = F3(
	function (col, currHue, _v0) {
		...
		return $avh4$elm_color$Color$fromHsla(
			_Utils_update(
				hsla,
				{av: currHue, o: 1 - (y / $simonh1000$elm_colorpicker$ColorPicker$widgetHeight), ay: x / $simonh1000$elm_colorpicker$ColorPicker$widgetWidth}));
	});
		...
		switch (mouseTarget.$) {
			case 2:
				return _Utils_update(
					model,
					{
						av: $elm$core$Maybe$Just(mouseInfo.ac / $simonh1000$elm_colorpicker$ColorPicker$widgetWidth)
					});
			case 1:
				...
				return _Utils_update(
					model,
					{
						av: $elm$core$Maybe$Just(
							A2($elm$core$Maybe$withDefault, hue, model.av))
					});
			case 3:
				var hue = mouseTarget.a;
				return _Utils_update(
	...
	function (message, col, model) {
		...
		var handleMouseMove = F2(
			function (mouseTarget, mouseInfo) {
				return (mouseInfo.aj && _Utils_eq(model.I, mouseTarget)) ? _Utils_Tuple2(
					A3($simonh1000$elm_colorpicker$ColorPicker$setHue, mouseTarget, mouseInfo, model),
					A2(calcNewColour, mouseTarget, mouseInfo)) : (((!mouseInfo.aj) && _Utils_eq(model.I, mouseTarget)) ? _Utils_Tuple2(
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var pickerMsg = msg.a;
				var _v1 = A3($simonh1000$elm_colorpicker$ColorPicker$update, pickerMsg, model.t, model.at);
				var pickerModel = _v1.a;
				var color = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							at: pickerModel,
							t: A2($elm$core$Maybe$withDefault, model.t, color)
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				var scheme = msg.a;
				var schemeColors = msg.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{aP: scheme, b: schemeColors}),
					$elm$core$Platform$Cmd$none);
			case 2:
				var color = msg.a;
				return _Utils_Tuple2(
			...
			case 3:
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							b: _Utils_ap(
								A2($elm$core$List$take, index, model.b),
								A2($elm$core$List$drop, index + 1, model.b))
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				var index = msg.a;
				var saturation = msg.b;
				var arrayedColors = $elm$core$Array$fromList(model.b);
				var adjustedColor = A4($author$project$Main$adjustColor, model, 1, index, saturation);
				var adjustedColors = function () {
					if (!adjustedColor.$) {
						var color = adjustedColor.a;
						return $elm$core$Array$toList(
							A3($elm$core$Array$set, index, color, arrayedColors));
					} else {
						return model.b;
					}
				}();
			...
			case 5:
				...
				var lightness = msg.b;
				var arrayedColors = $elm$core$Array$fromList(model.b);
				var adjustedColor = A4($author$project$Main$adjustColor, model, 2, index, lightness);
				var adjustedColors = function () {
					if (!adjustedColor.$) {
						var color = adjustedColor.a;
						return $elm$core$Array$toList(
			...
			case 6:
				var dndMsg = msg.a;
				var _v4 = A3($author$project$Main$dndSystem.b$, dndMsg, model.E, model.b);
				var dnd = _v4.a;
				var colors = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{E: dnd, b: colors}),
					$author$project$Main$dndSystem.cH(model.E));
			case 7:
				var colorCode = msg.a;
				return _Utils_Tuple2(
					model,
					$author$project$Main$copyString(colorCode));
			case 8:
				var ontoIndex = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							G: $elm$core$Maybe$Just(ontoIndex)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var fromIndex = msg.a;
					...
					_Utils_update(
						model,
						{
							G: function () {
								...
								if (!_v5.$) {
									var index = _v5.a;
									return _Utils_eq(fromIndex, index) ? $elm$core$Maybe$Nothing : model.G;
								} else {
									return model.G;
								}
							}()
...
var $mdgriffith$elm_ui$Internal$Style$classes = {b7: 'a', aT: 'atv', b9: 'ab', ca: 'cx', cb: 'cy', cc: 'acb', cd: 'accx', ce: 'accy', cf: 'acr', bd: 'al', be: 'ar', cg: 'at', aU: 'ah', aV: 'av', ci: 's', cn: 'bh', co: 'b', cs: 'w7', cu: 'bd', cv: 'bdt', aG: 'bn', cw: 'bs', aH: 'cpe', cD: 'cp', cE: 'cpx', cF: 'cpy', C: 'c', aJ: 'ctr', aK: 'cb', aL: 'ccx', D: 'ccy', au: 'cl', aM: 'cr', cI: 'ct', cJ: 'cptr', cK: 'ctxt', cS: 'fcs', bn: 'focus-within', cT: 'fs', cX: 'g', aX: 'hbh', aY: 'hc', bs: 'he', aZ: 'hf', bt: 'hfp', c_: 'hv', c0: 'ic', c2: 'fr', c5: 'iml', c6: 'imlf', c7: 'imlp', c8: 'implw', c9: 'it', da: 'i', bz: 'lnk', ak: 'nb', bD: 'notxt', dm: 'ol', dn: 'or', X: 'oq', dt: 'oh', bH: 'pg', bI: 'p', du: 'ppe', dz: 'ui', u: 'r', dC: 'sb', dD: 'sbx', dE: 'sby', dF: 'sbt', dH: 'e', dI: 'cap', dJ: 'sev', dO: 'sk', p: 't', dR: 'tc', dS: 'w8', dT: 'w2', dU: 'w9', dV: 'tj', aQ: 'tja', dW: 'tl', dX: 'w3', dY: 'w5', dZ: 'w4', d_: 'tr', d$: 'w6', d0: 'w1', d1: 'tun', b_: 'ts', aa: 'clr', d6: 'u', a9: 'wc', b4: 'we', ba: 'wf', b5: 'wfp', bb: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.ci + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.C);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.ci + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cX);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.ci + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bH);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.ci + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bI);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.ci + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.u);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.ci + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dH);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.dA)) + ('-cols-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.w)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dK.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dK.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.u) + ('-' + ($elm$core$String$fromInt(pos.cG) + ('-' + ($elm$core$String$fromInt(pos.a8) + ('-' + $elm$core$String$fromInt(pos.br)))))));
		case 11:
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.c_, $mdgriffith$elm_ui$Internal$Style$classes.aa)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.c_, $mdgriffith$elm_ui$Internal$Style$classes.X)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cS, $mdgriffith$elm_ui$Internal$Style$classes.aa)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.aT, $mdgriffith$elm_ui$Internal$Style$classes.X)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ci) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.u) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ci) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ci) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.u) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ci) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.aJ) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aI: closing, i: _List_Nil, L: _List_Nil, A: selector};
	});
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.A + ('{' + (renderValues(rule.L) + (rule.aI + '}')));
		}
	};
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 5:
				...
				var single = '.' + $mdgriffith$elm_ui$Internal$Style$classes.dH;
			...
			case 8:
				...
				var xSpacing = toGridLength(template.dK.a);
				var ySpacing = toGridLength(template.dK.b);
				var rows = function (x) {
				...
				var msColumns = function (x) {
					...
					A2(
						...
						ySpacing,
						A2($elm$core$List$map, toGridLength, template.w)));
				var gapY = 'grid-row-gap:' + (toGridLength(template.dK.b) + ';');
				var gapX = 'grid-column-gap:' + (toGridLength(template.dK.a) + ';');
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							...
							'grid-column: ' + ($elm$core$String$fromInt(position.cG) + (' / ' + ($elm$core$String$fromInt(position.cG + position.a8) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.u) + ('-' + ($elm$core$String$fromInt(position.cG) + ('-' + ($elm$core$String$fromInt(position.a8) + ('-' + $elm$core$String$fromInt(position.br)))))));
...
var $mdgriffith$elm_ui$Internal$Model$renderFontAdjustmentRule = F3(
	function (fontToAdjust, _v0, otherFontName) {
		...
		return A2(
			...
			' ',
			_Utils_ap(
				A3($mdgriffith$elm_ui$Internal$Model$fontRule, name, $mdgriffith$elm_ui$Internal$Style$classes.dI, capital),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.dI + (', ' + ('.' + (name + (' .' + $mdgriffith$elm_ui$Internal$Style$classes.dI))))))),
					_List_fromArray(
						[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.dI + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.p + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.dI + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.p)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {br: height / size, an: size, b2: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cA, adjustment.cl, adjustment.cL, adjustment.de]);
	var lineHeight = 1.5;
	...
	return _Utils_Tuple2(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'font-size',
				$elm$core$String$fromFloat(converted.an) + 'em')
			]));
};
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.ci + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dH))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ci, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.aJ, $mdgriffith$elm_ui$Internal$Style$classes.D, $mdgriffith$elm_ui$Internal$Style$classes.cf])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ci, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.aJ, $mdgriffith$elm_ui$Internal$Style$classes.D, $mdgriffith$elm_ui$Internal$Style$classes.cd])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ci, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.aJ, $mdgriffith$elm_ui$Internal$Style$classes.ce])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ci, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.aJ, $mdgriffith$elm_ui$Internal$Style$classes.cc])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.ci + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.p + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.a9 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aY)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.ci + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.p + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.ba + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aZ)))));
					...
					case 1:
						...
						return _Utils_eq(context, $mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.c$, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ak, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.b7]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ak, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.co]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ak, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.dn]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ak, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.dm]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ak, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.c2]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ak, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.cn]));
						}
					}())
				]),
			_List_fromArray(
				[
					...
					switch (elem.$) {
						...
						default:
							var styled = elem.a;
							return A2(styled.c$, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, $mdgriffith$elm_ui$Internal$Model$asEl);
					}
				}()
				]));
	});
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		...
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.aU + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.be);
		default:
...
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.aV + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cg);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.aV + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b9);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.aV + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cb);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.ci + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.u + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
				...
				case 0:
					...
					if (_v4.$ === 1) {
						return _Utils_update(
							record,
							{
								c_: $elm$core$Maybe$Just(hoverable)
							});
					} else {
						return record;
					}
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{cS: $elm$core$Maybe$Nothing, c_: $elm$core$Maybe$Nothing, dg: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.dz, $mdgriffith$elm_ui$Internal$Style$classes.ci, $mdgriffith$elm_ui$Internal$Style$classes.dH]))),
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.au + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.D)),
				A2(
					$elm$core$List$cons,
...
var $author$project$Main$viewStewedColor = F2(
	function (attributesForDndHandling, color) {
		return A2(
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Main$toElmUiColor(color))
					]),
				attributesForDndHandling),
			$mdgriffith$elm_ui$Element$none);
	});
var $author$project$Main$viewGhostStewedColor = F2(
	function (dndModel, colors) {
		var maybeDragColor = A2(
			$elm$core$Maybe$andThen,
			function (_v1) {
				var dragIndex = _v1.bk;
				return $elm$core$List$head(
					A2($elm$core$List$drop, dragIndex, colors));
			},
			$author$project$Main$dndSystem.bw(dndModel));
		var attributesForDndHandling = A2(
			$elm$core$List$map,
			$mdgriffith$elm_ui$Element$htmlAttribute,
			$author$project$Main$dndSystem.cU(dndModel));
		if (!maybeDragColor.$) {
			var color = maybeDragColor.a;
			return A2($author$project$Main$viewStewedColor, attributesForDndHandling, color);
		} else {
			return $mdgriffith$elm_ui$Element$none;
		}
	});
var $author$project$Main$Analogous = 2;
var $author$project$Main$Compound = 3;
var $author$project$Main$Dyad = 0;
var $author$project$Main$Pentad = 6;
var $author$project$Main$Rectangle = 5;
var $author$project$Main$Square = 4;
var $author$project$Main$Triad = 1;
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cI + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.au)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $mdgriffith$elm_ui$Element$Font$heavy = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.dU);
...
var $author$project$Main$PickColor = function (a) {
	return {$: 0, a: a};
};
...
var $simonh1000$elm_colorpicker$ColorPicker$NoOp = {$: 4};
...
var $simonh1000$elm_colorpicker$ColorPicker$HueSlider = {$: 2};
...
var $simonh1000$elm_colorpicker$ColorPicker$OnMouseUp = {$: 3};
var $simonh1000$elm_colorpicker$ColorPicker$MouseInfo = F3(
	function (x, y, mousePressed) {
		return {aj: mousePressed, ac: x, ad: y};
	});
...
var $simonh1000$elm_colorpicker$ColorPicker$view = F2(
	function (col, _v0) {
		var model = _v0;
		var hsla = $avh4$elm_color$Color$toHsla(col);
		var hue = A2($elm$core$Maybe$withDefault, hsla.av, model.av);
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A3($simonh1000$elm_colorpicker$ColorPicker$satLightPalette, hue, colCss, model.I),
					...
					_List_fromArray(
						[
							$simonh1000$elm_colorpicker$ColorPicker$huePalette(model.I),
					...
					_List_fromArray(
						[
							...
							$simonh1000$elm_colorpicker$ColorPicker$alphaMarker(hsla.aF)
						]))
				]));
	});
var $author$project$Main$viewColorPicker = function (model) {
	return $mdgriffith$elm_ui$Element$html(
		A2(
			$elm$html$Html$map,
			$author$project$Main$PickColor,
			A2($simonh1000$elm_colorpicker$ColorPicker$view, model.t, model.at)));
};
var $author$project$Main$SelectScheme = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var $author$project$Main$colorSchemeToString = function (scheme) {
	switch (scheme) {
		case 7:
...
var $author$project$Main$pickNthNext = F3(
	function (baseColor, total, n) {
		var hueDifferenceUnit = 1 / total;
		return $avh4$elm_color$Color$fromHsla(
			function (hsla) {
				var gainedHue = hsla.av + (n * hueDifferenceUnit);
				var pickedHue = (gainedHue >= 1) ? (gainedHue - 1) : ((_Utils_cmp(gainedHue, -1) < 1) ? (gainedHue + 1) : gainedHue);
				return _Utils_update(
					hsla,
					{av: pickedHue});
			}(
...
var $author$project$Main$pickAnalogous = function (baseColor) {
	return _List_fromArray(
		[
			baseColor,
			A3($author$project$Main$pickNthNext, baseColor, 12, 1),
			A3($author$project$Main$pickNthNext, baseColor, 12, -1)
		]);
};
var $author$project$Main$pickCompound = function (color) {
	return _List_fromArray(
		[
			color,
			A3($author$project$Main$pickNthNext, color, 12, 5),
			A3($author$project$Main$pickNthNext, color, 12, 7)
		]);
};
var $author$project$Main$pickPolyad = F2(
	function (baseColor, dimension) {
		return A2(
			$elm$core$List$map,
			A2($author$project$Main$pickNthNext, baseColor, dimension),
			A2($elm$core$List$range, 0, dimension - 1));
	});
var $author$project$Main$pickDyad = function (baseColor) {
	return A2($author$project$Main$pickPolyad, baseColor, 2);
};
var $author$project$Main$pickPentad = function (baseColor) {
	return A2($author$project$Main$pickPolyad, baseColor, 5);
};
var $author$project$Main$pickRectangle = function (baseColor) {
	return _List_fromArray(
		[
			baseColor,
			A3($author$project$Main$pickNthNext, baseColor, 6, 1),
			A3($author$project$Main$pickNthNext, baseColor, 6, 3),
			A3($author$project$Main$pickNthNext, baseColor, 6, 4)
		]);
};
var $author$project$Main$pickSquare = function (baseColor) {
	return A2($author$project$Main$pickPolyad, baseColor, 4);
};
var $author$project$Main$pickTriad = function (baseColor) {
	return A2($author$project$Main$pickPolyad, baseColor, 3);
};
var $author$project$Main$pickSchemeColors = F2(
	function (scheme, baseColor) {
		switch (scheme) {
			case 7:
				return $author$project$Main$pickMonochromatic(baseColor);
			case 0:
				return $author$project$Main$pickDyad(baseColor);
			case 1:
				return $author$project$Main$pickTriad(baseColor);
			case 2:
				return $author$project$Main$pickAnalogous(baseColor);
			case 3:
				return $author$project$Main$pickCompound(baseColor);
			case 4:
				return $author$project$Main$pickSquare(baseColor);
			case 5:
				return $author$project$Main$pickRectangle(baseColor);
			default:
				return $author$project$Main$pickPentad(baseColor);
		}
	});
...
var $author$project$Main$viewColorSet = function (colors) {
	return A2(
		...
		A2(
			...
			A2($elm$core$List$map, $author$project$Main$toElmUiColor, colors)));
};
var $avh4$elm_color$Color$white = A4($avh4$elm_color$Color$RgbaSpace, 255 / 255, 255 / 255, 255 / 255, 1.0);
var $author$project$Main$viewColorScheme = F2(
	function (scheme, model) {
		var schemeName = $author$project$Main$colorSchemeToString(scheme);
		var schemeColors = A2($author$project$Main$pickSchemeColors, scheme, model.t);
		var backgroundColor = function () {
			if (_Utils_eq(scheme, model.aP)) {
				return $avh4$elm_color$Color$gray;
			} else {
				var _v0 = model.a_;
				if (!_v0.$) {
					var hoveredColorScheme = _v0.a;
					return _Utils_eq(scheme, hoveredColorScheme) ? $avh4$elm_color$Color$lightGray : $avh4$elm_color$Color$white;
				} else {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($author$project$Main$SelectScheme, scheme, schemeColors)),
					$mdgriffith$elm_ui$Element$mouseOver(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color(
							$author$project$Main$toElmUiColor($avh4$elm_color$Color$lightGray))
						])),
					...
					$mdgriffith$elm_ui$Element$Background$color(
					$author$project$Main$toElmUiColor(backgroundColor))
				]),
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text(schemeName),
					$author$project$Main$viewColorSet(schemeColors)
				]));
	});
var $author$project$Main$viewLeftPane = function (model) {
	var monochromaticColors = $author$project$Main$pickMonochromatic(model.t);
	var adjustVisibility = function (color) {
		var hsla = $avh4$elm_color$Color$toHsla(color);
		return (hsla.aF < 0.5) ? A4($avh4$elm_color$Color$hsla, hsla.av, hsla.ay, 1.0 - hsla.o, 1.0 - hsla.aF) : color;
	};
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
					...
					[
						...
						$author$project$Main$toElmUiColor(
							A2(
								...
								$elm$core$List$head(monochromaticColors))))
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								A2($mdgriffith$elm_ui$Element$paddingXY, 25, 5),
								...
								$author$project$Main$toElmUiColor(
									adjustVisibility(
										A2(
											...
											$elm$core$List$head(
												A2($elm$core$List$drop, 4, monochromaticColors))))))
							]),
						A2(
							$mdgriffith$elm_ui$Element$column,
							_List_fromArray(
						...
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$centerX]),
						$author$project$Main$viewColorPicker(model))
					])),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						...
						$author$project$Main$toElmUiColor(
							A2(
								...
								$avh4$elm_color$Color$black,
								$elm$core$List$head(
									A2($elm$core$List$drop, 1, monochromaticColors)))))
					]),
				A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
					$mdgriffith$elm_ui$Element$text('Color Sheme Templates'))),
				A2($author$project$Main$viewColorScheme, 7, model),
				A2($author$project$Main$viewColorScheme, 0, model),
				A2($author$project$Main$viewColorScheme, 1, model),
				A2($author$project$Main$viewColorScheme, 2, model),
				A2($author$project$Main$viewColorScheme, 3, model),
				A2($author$project$Main$viewColorScheme, 4, model),
				A2($author$project$Main$viewColorScheme, 5, model),
				A2($author$project$Main$viewColorScheme, 6, model)
			]));
};
var $author$project$Main$Blackish = 0;
var $author$project$Main$AddColor = function (a) {
	return {$: 2, a: a};
};
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aL + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.D + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dF + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bD)))))),
						A2(
							$elm$core$List$cons,
...
var $author$project$Main$pickBlackishColor = function (baseColor) {
	return $avh4$elm_color$Color$fromHsla(
		function (hsla) {
			return _Utils_update(
				hsla,
				{
					o: A2(
						$elm$core$Basics$min,
						A2($elm$core$Basics$pow, hsla.o, 2),
						0.13)
				});
		}(
			$avh4$elm_color$Color$toHsla(baseColor)));
};
var $author$project$Main$pickWhitishColor = function (baseColor) {
	return $avh4$elm_color$Color$fromHsla(
		function (hsla) {
			return _Utils_update(
				hsla,
				{
					o: A2(
						$elm$core$Basics$max,
						A2($elm$core$Basics$pow, hsla.o, 0.5),
						0.97)
				});
		}(
			$avh4$elm_color$Color$toHsla(baseColor)));
...
var $author$project$Main$viewButtonForAddtionColor = F3(
	function (isEnabled, additionalColorType, baseColor) {
		var labelColor = function () {
			if (isEnabled) {
				if (!additionalColorType) {
					return $avh4$elm_color$Color$white;
				} else {
		...
		var iconPath = function () {
			if (isEnabled) {
				if (!additionalColorType) {
					return 'assets/white-plus.svg';
				} else {
					return 'assets/black-plus.svg';
				}
			} else {
				return 'assets/darkgray-plus.svg';
			}
		}();
		var additionalColor = function () {
			if (!additionalColorType) {
				return $author$project$Main$pickBlackishColor(baseColor);
			} else {
				return $author$project$Main$pickWhitishColor(baseColor);
			}
		}();
		var backgroundColor = isEnabled ? additionalColor : $avh4$elm_color$Color$lightGray;
		return A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$height(
									$mdgriffith$elm_ui$Element$px(15)),
									$mdgriffith$elm_ui$Element$Background$uncropped(iconPath)
								]),
							$mdgriffith$elm_ui$Element$none),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$Font$size(15),
									$mdgriffith$elm_ui$Element$Font$color(
									$author$project$Main$toElmUiColor(labelColor))
								]),
							$mdgriffith$elm_ui$Element$text(label))
						])),
				a2: isEnabled ? $elm$core$Maybe$Just(
					$author$project$Main$AddColor(additionalColor)) : $elm$core$Maybe$Nothing
			});
	});
var $author$project$Main$viewButtonForBlackishColor = function (model) {
	return A3(
		$author$project$Main$viewButtonForAddtionColor,
		$elm$core$List$length(model.b) < 5,
		0,
		model.t);
};
var $author$project$Main$Whitish = 1;
var $author$project$Main$viewButtonForWhitishColor = function (model) {
	return A3(
		$author$project$Main$viewButtonForAddtionColor,
		$elm$core$List$length(model.b) < 5,
		1,
...
var $author$project$Logo$originalSize = {br: 926, a8: 1368};
...
var $author$project$Logo$logo = F2(
	function (width_, color) {
		var scaleX = (0.1 * width_) / $author$project$Logo$originalSize.a8;
		var scaleY = -scaleX;
		var height_ = ($author$project$Logo$originalSize.br * width_) / $author$project$Logo$originalSize.a8;
		return A2(
			$elm$svg$Svg$svg,
			_List_fromArray(
				[
					...
					'0 0 ' + ($elm$core$String$fromFloat(width_) + (' ' + $elm$core$String$fromFloat(height_)))),
				...
				[
					...
					_List_fromArray(
						[
							...
							'translate(0,' + ($elm$core$String$fromFloat(height_) + (') scale(' + ($elm$core$String$fromFloat(scaleX) + (',' + ($elm$core$String$fromFloat(scaleY) + ')')))))),
							$elm$svg$Svg$Attributes$fill(
							$noahzgordon$elm_color_extra$Color$Convert$colorToHex(color)),
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$d('M6630 8394 c-747 -88 -1426 -464 -1894 -1049 -251 -315 -450 -723 -544 -1120 -17 -71 -38 -179 -47 -240 -18 -125 -35 -410 -26 -440 3 -11 6 -739 7 -1617 l1 -1596 46 -54 c25 -29 75 -87 111 -129 l65 -76 -37 -6 c-20 -3 -165 -24 -322 -46 -611 -86 -737 -113 -908 -192 -117 -54 -218 -118 -271 -173 -25 -25 -43 -48 -40 -50 3 -3 137 4 298 15 162 10 335 21 385 23 50 2 260 15 466 30 206 14 467 32 579 40 l203 14 143 -108 c536 -406 1084 -631 1765 -726 154 -21 569 -30 730 -15 617 56 1141 235 1645 560 188 121 342 247 551 454 l161 158 279 20 c548 38 604 52 674 165 73 118 64 457 -17 601 -63 113 -137 157 -315 189 -106 18 -194 14 -340 -15 -51 -11 -113 -22 -137 -26 l-44 -7 5 1333 5 1334 -23 190 c-29 231 -37 278 -75 427 -78 314 -210 612 -388 880 -120 180 -201 279 -356 434 -459 462 -1043 743 -1700 819 -159 18 -476 18 -635 -1z m729 -333 c266 -46 480 -114 716 -231 257 -126 433 -251 649 -460 392 -380 647 -879 731 -1430 23 -147 30 -430 16 -586 -103 -1113 -919 -2023 -2011 -2243 -179 -36 -283 -46 -495 -45 -301 0 -511 33 -785 124 -930 307 -1579 1096 -1711 2080 -20 148 -17 510 5 655 85 565 342 1067 742 1455 402 389 893 623 1464 696 157 20 519 12 679 -15z m2124 -5132 c-8 -8 -401 -75 -718 -124 -93 -15 -201 -33 -240 -41 -114 -24 -2260 -381 -3575 -595 l-185 -30 -30 34 c-16 19 -51 59 -76 88 -57 66 -170 222 -193 268 -17 31 -18 94 -16 859 0 455 2 827 4 829 1 2 33 -49 71 -112 111 -187 243 -354 419 -531 167 -167 278 -259 454 -375 584 -387 1314 -542 2012 -429 864 141 1613 672 2041 1447 l34 62 3 -672 c1 -369 -1 -674 -5 -678z m-323 -972 c-203 -194 -510 -397 -791 -523 -673 -302 -1434 -358 -2164 -158 -313 86 -643 238 -927 428 l-79 53 78 7 c43 3 467 31 943 62 476 31 1326 86 1890 124 564 37 1045 68 1070 68 l45 1 -65 -62z')
								]),
							_List_Nil),
							A2(
							$elm$svg$Svg$path,
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$d('M6900 7564 c-136 -19 -527 -106 -655 -145 -127 -39 -207 -80 -489 -248 -261 -155 -304 -192 -401 -339 -88 -135 -129 -226 -171 -385 -34 -130 -100 -353 -169 -575 -88 -285 -88 -498 2 -847 91 -354 217 -648 368 -860 154 -217 424 -429 750 -590 266 -132 452 -171 775 -162 440 12 889 142 1255 365 531 323 931 853 1079 1432 36 143 56 280 39 280 -13 0 -27 -31 -78 -175 -211 -591 -441 -954 -772 -1220 -108 -86 -246 -165 -290 -165 -21 0 4 28 156 177 249 241 377 413 514 688 51 104 113 257 142 353 12 38 11 42 -3 42 -12 0 -26 -24 -46 -83 -142 -402 -435 -766 -728 -902 -107 -50 -104 -29 10 66 261 219 435 452 563 755 81 190 129 369 171 629 8 49 13 174 13 320 0 258 -12 363 -62 555 -27 105 -79 208 -96 191 -7 -7 -2 -37 16 -98 105 -346 123 -715 52 -1069 -34 -168 -118 -396 -155 -419 -14 -9 -14 -9 24 175 51 244 60 333 60 560 0 348 -57 609 -191 872 -146 288 -360 492 -673 642 -133 64 -342 135 -486 166 -132 28 -378 35 -524 14z m230 -455 c182 -22 455 -136 666 -277 221 -148 363 -305 460 -507 80 -166 105 -274 111 -477 9 -270 -34 -480 -140 -693 -127 -257 -307 -419 -560 -505 -216 -73 -352 -59 -506 55 -61 44 -241 230 -321 330 -138 174 -169 331 -75 371 86 36 169 -18 282 -182 97 -140 205 -249 289 -290 52 -25 70 -29 149 -29 75 0 98 4 140 25 117 57 187 175 260 440 68 248 88 363 89 515 1 268 -79 456 -289 674 -157 164 -388 319 -559 376 -43 15 -140 35 -215 46 -165 24 -171 26 -171 48 0 35 147 82 280 90 14 0 64 -4 110 -10z m-243 -509 c23 -7 54 -23 69 -36 27 -21 28 -24 12 -40 -10 -11 -81 -30 -205 -55 -550 -111 -638 -143 -774 -280 -63 -63 -86 -95 -128 -180 -113 -230 -129 -446 -50 -685 61 -182 155 -304 398 -512 237 -204 361 -349 361 -424 0 -40 -29 -43 -158 -19 -209 40 -303 85 -525 254 -361 273 -559 748 -482 1156 47 245 209 561 347 674 95 78 206 110 441 128 78 6 216 16 307 24 183 15 326 13 387 -5z')
								]),
							_List_Nil),
							A2(
							$elm$svg$Svg$path,
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$d('M11243 3359 c-164 -21 -272 -109 -368 -300 -96 -189 -102 -409 -18 -664 40 -124 184 -290 302 -349 98 -49 256 -66 516 -54 183 8 296 35 675 162 458 153 751 293 888 424 77 75 102 119 122 216 13 65 6 144 -15 152 -7 3 -39 -8 -71 -24 -33 -16 -106 -39 -163 -51 -96 -20 -114 -21 -244 -11 -245 20 -708 151 -842 239 -22 15 -128 71 -236 124 -271 134 -370 159 -546 136z m784 -475 c53 -25 123 -54 155 -65 91 -29 294 -76 378 -88 272 -39 371 -49 448 -44 75 5 82 4 82 -13 -1 -73 -537 -320 -920 -424 -232 -63 -350 -74 -407 -39 -41 25 -73 85 -73 135 0 32 10 46 79 118 43 44 83 90 89 102 20 38 24 121 12 207 -6 47 -9 95 -5 106 5 17 45 48 63 51 2 0 47 -21 99 -46z')
								]),
							_List_Nil)
						]))
				]));
...
var $author$project$Main$viewPreview = function (model) {
	var logoColor = A2(
		...
		$elm$core$List$head(
			A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				$elm$core$List$tail(model.b))));
	var textBackgroundColor = A2(
		$elm$core$Maybe$withDefault,
		logoColor,
		$elm$core$List$head(
			A2($elm$core$List$drop, 3, model.b)));
	var titleColor = A2(
		$elm$core$Maybe$withDefault,
		logoColor,
		$elm$core$List$head(
			A2($elm$core$List$drop, 2, model.b)));
	var baseColor = A2(
		$elm$core$Maybe$withDefault,
		$avh4$elm_color$Color$black,
	...
	var textColor = A2(
		...
		baseColor,
		$elm$core$List$head(
			A2($elm$core$List$drop, 4, model.b)));
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$centerX,
				$mdgriffith$elm_ui$Element$Background$color(
				$author$project$Main$toElmUiColor(baseColor)),
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$color(
						$author$project$Main$toElmUiColor(titleColor)),
						$mdgriffith$elm_ui$Element$Font$size(30),
						$mdgriffith$elm_ui$Element$Font$heavy,
						$mdgriffith$elm_ui$Element$centerX,
						$mdgriffith$elm_ui$Element$paddingEach(
						{cx: 0, db: 0, dy: 0, d3: 20})
					]),
				$mdgriffith$elm_ui$Element$text('Color Stew')),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				$mdgriffith$elm_ui$Element$html(
					A2($author$project$Logo$logo, 380, logoColor))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Background$color(
						$author$project$Main$toElmUiColor(textBackgroundColor)),
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
					]),
				A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Font$color(
							$author$project$Main$toElmUiColor(textColor)),
					...
					A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('Color Stew is a design tool for experiments of color combinations.'),
								$mdgriffith$elm_ui$Element$text(' First pick a base color whatever you like at the top left, then Color Stew automatically generates 11 different color schemes.'),
								$mdgriffith$elm_ui$Element$text(' Just select one of them to check how it looks.'),
								$mdgriffith$elm_ui$Element$text(' Generated color schemes are possibly not so cool.'),
								$mdgriffith$elm_ui$Element$text(' But don\'t worry. You can adjust each color\'s saturation and lightness to make it better.'),
								$mdgriffith$elm_ui$Element$text(' You don\'t like color placements? Just change the order by drag & drop to arrange them.'),
								$mdgriffith$elm_ui$Element$text(' Let\'s find cool color combinations with Color Scheme.')
							]))))
			]));
};
var $elm$html$Html$Attributes$id = $elm$html$Html$Attributes$stringProperty('id');
var $author$project$Main$AdjustLightness = F2(
	function (a, b) {
		return {$: 5, a: a, b: b};
	});
var $author$project$Main$AdjustSaturation = F2(
	function (a, b) {
		return {$: 4, a: a, b: b};
	});
var $author$project$Main$CopyColorCode = function (a) {
	return {$: 7, a: a};
};
var $author$project$Main$EnterMouseOntoStewedColor = function (a) {
	return {$: 8, a: a};
};
var $author$project$Main$LeaveMouseFromStewedColor = function (a) {
	return {$: 9, a: a};
};
var $author$project$Main$RemoveColor = function (a) {
	return {$: 3, a: a};
};
...
var $mdgriffith$elm_ui$Element$Input$slider = F2(
	function (attributes, input) {
		...
		var factor = (input.b0 - input.bB) / (input.bA - input.bB);
		var _v0 = input.bZ;
		...
		return A3(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Input$isHiddenLabel(input.aw) ? $mdgriffith$elm_ui$Internal$Model$NoAttribute : A2($mdgriffith$elm_ui$Element$spacingXY, spacingX, spacingY),
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$min(
									$elm$core$String$fromFloat(input.bB))),
								$mdgriffith$elm_ui$Internal$Model$Attr(
								$elm$html$Html$Attributes$max(
									$elm$core$String$fromFloat(input.bA))),
								$mdgriffith$elm_ui$Internal$Model$Attr(
								$elm$html$Html$Attributes$value(
									$elm$core$String$fromFloat(input.b0))),
...
var $author$project$Main$viewStewedColorWithSurroundings = F4(
	function (model, attributesForDndHandling, index, color) {
		var colorHsla = $avh4$elm_color$Color$toHsla(color);
		var backgroundColor = function () {
			var _v0 = model.G;
			if (!_v0.$) {
				var hoveredIndex = _v0.a;
				return _Utils_eq(index, hoveredIndex) ? $avh4$elm_color$Color$lightGray : $avh4$elm_color$Color$white;
			} else {
				return $avh4$elm_color$Color$white;
			}
		}();
					...
					A2(
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
								$mdgriffith$elm_ui$Element$Background$uncropped('assets/minus.svg')
							]),
						{
							aw: $mdgriffith$elm_ui$Element$none,
							a2: $elm$core$Maybe$Just(
								$author$project$Main$RemoveColor(index))
						})),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						...
						[
								...
								[
									...
									_List_fromArray(
										[
											...
											$mdgriffith$elm_ui$Element$height(
											$mdgriffith$elm_ui$Element$px(20)),
											$mdgriffith$elm_ui$Element$Background$uncropped('assets/clipboard.svg')
										]),
									{
										aw: $mdgriffith$elm_ui$Element$none,
										a2: $elm$core$Maybe$Just(
											$author$project$Main$CopyColorCode(
												$noahzgordon$elm_color_extra$Color$Convert$colorToHex(color)))
									})
								])),
							A2(
							...
							_List_fromArray(
								[
									...
									$author$project$Main$EnterMouseOntoStewedColor(index)),
									$mdgriffith$elm_ui$Element$Events$onMouseLeave(
									$author$project$Main$LeaveMouseFromStewedColor(index))
								]),
							A2($author$project$Main$viewStewedColor, attributesForDndHandling, color)),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
							...
							A2(
								...
								{
									aw: $mdgriffith$elm_ui$Element$Input$labelHidden(
										$elm$core$String$fromFloat(colorHsla.ay)),
									bA: 1,
									bB: 0,
									bF: $author$project$Main$AdjustSaturation(index),
									bV: $elm$core$Maybe$Nothing,
									bZ: $mdgriffith$elm_ui$Element$Input$thumb(
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$Background$color(
												$author$project$Main$toElmUiColor($avh4$elm_color$Color$white)),
												...
												$mdgriffith$elm_ui$Element$height(
												$mdgriffith$elm_ui$Element$px(20)),
												$mdgriffith$elm_ui$Element$Background$uncropped('assets/saturation.svg')
											])),
									b0: colorHsla.ay
								})),
							A2(
							...
							A2(
								...
								{
									aw: $mdgriffith$elm_ui$Element$Input$labelHidden(
										$elm$core$String$fromFloat(colorHsla.o)),
									bA: 1,
									bB: 0,
									bF: $author$project$Main$AdjustLightness(index),
									bV: $elm$core$Maybe$Nothing,
									bZ: $mdgriffith$elm_ui$Element$Input$thumb(
										_List_fromArray(
											[
												...
												$mdgriffith$elm_ui$Element$height(
												$mdgriffith$elm_ui$Element$px(20)),
												$mdgriffith$elm_ui$Element$Background$uncropped('assets/lightness.svg')
											])),
									b0: colorHsla.o
								}))
						])),
...
var $author$project$Main$viewRealStewedColor = F3(
	function (model, index, color) {
		var colorId = 'stewedColor-' + $elm$core$String$fromInt(index);
		var attributesForDndHandling = function () {
			var _v0 = $author$project$Main$dndSystem.bw(model.E);
			if (!_v0.$) {
				var dragIndex = _v0.a.bk;
				return (!_Utils_eq(dragIndex, index)) ? A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$htmlAttribute(
						$elm$html$Html$Attributes$id(colorId)),
					A2(
						$elm$core$List$map,
						$mdgriffith$elm_ui$Element$htmlAttribute,
						A2($author$project$Main$dndSystem.cO, index, colorId))) : _List_fromArray(
					[
						$mdgriffith$elm_ui$Element$htmlAttribute(
						$elm$html$Html$Attributes$id(colorId))
					]);
				...
				return A2(
					...
					A2(
						$elm$core$List$map,
						$mdgriffith$elm_ui$Element$htmlAttribute,
						A2($author$project$Main$dndSystem.cN, index, colorId)));
			}
		}();
		return A4($author$project$Main$viewStewedColorWithSurroundings, model, attributesForDndHandling, index, color);
	});
var $author$project$Main$viewMainPane = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					A2(
						$elm$core$List$indexedMap,
						$author$project$Main$viewRealStewedColor(model),
						model.b),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$author$project$Main$viewButtonForBlackishColor(model),
									$author$project$Main$viewButtonForWhitishColor(model)
								]))
						])))
			]));
};
		...
		$mdgriffith$elm_ui$Element$layoutWith,
		{
			ds: _List_fromArray(
				[
					...
					{ck: $elm$core$Maybe$Nothing, ct: $elm$core$Maybe$Nothing, dG: $elm$core$Maybe$Nothing})
				])
		},
		_List_fromArray(
			[
				...
				A2($author$project$Main$viewGhostStewedColor, model.E, model.b)),
				$mdgriffith$elm_ui$Element$Font$family(
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$typeface('Latha'),
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Main$viewMainPane(model)
				])));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{c4: $author$project$Main$init, bX: $author$project$Main$subscriptions, b$: $author$project$Main$update, d7: $author$project$Main$view});
